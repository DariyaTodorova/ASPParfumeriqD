...
namespace ASPParfumeriq.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Products.Include(p => p.Category).Include(p => p.TypeParfume);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,CategoryId,Quantity,TypeParfumeId,PhotoUrl,Price,Description")] Product product)
        {
            product.RegisterOn = DateTime.Now;
            if (id != product.Id)
            {
