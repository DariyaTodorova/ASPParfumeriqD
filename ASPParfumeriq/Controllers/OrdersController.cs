...
namespace ASPParfumeriq.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,OrderQuantity")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,OrderQuantity")] Order order)
        {
            order.RegisterOn = DateTime.Now;
            if (id != order.Id)
            {
